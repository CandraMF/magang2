...
rel:"stylesheet",type:"text/css"},null,document.getElementsByTagName("head")[0]);f(c.Chart,"afterGetContainer",function(){this.container.style.background="url(https://www.jabarsoft.com/samples/graphics/sand.png)"});d(a.options)}})(e||(e={}));return e});b(a,"masters/themes/sand-signika.src.js",[a["Core/Globals.js"],a["Extensions/Themes/SandSignika.js"]],function(a,b){a.theme=b.options;b.apply()})});
