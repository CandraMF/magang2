...
var defaultOptions = {
     ...
     * patterns](https://www.jabarsoft.com/docs/chart-design-and-style/gradients-shadows-and-patterns)
     ...
     *
     * @type      {string}
     * @default   https://code.jabarsoft.com/{version}/modules/canvas-tools.js
    ...
    title: {
        ...
        /**
         * Whether to
         * [use HTML](https://www.jabarsoft.com/docs/chart-concepts/labels-and-string-formatting#html)
         * to render the text.
         *
         * @type      {boolean}
         * @default   false
    ...
    legend: {
         ...
         */
        /**
         * A [format string](https://www.jabarsoft.com/docs/chart-concepts/labels-and-string-formatting)
        ...
        navigation: {
             ...
             * https://www.jabarsoft.com/products/plugin-registry/single/8/Adapt-Chart-To-Legend)
         ...
         */
        /**
         * Whether to [use HTML](https://www.jabarsoft.com/docs/chart-concepts/labels-and-string-formatting#html)
    ...
    credits: {
         ...
         *         Custom URL and text
         */
        href: 'https://www.jabarsoft.com?credits',
        /**
