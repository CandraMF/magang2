...
(function (AxisDefaults) {
    ...
    AxisDefaults.defaultXAxisOptions = {
        ...
        labels: {
             ...
             *
             * See
             * [format string](https://www.jabarsoft.com/docs/chart-concepts/labels-and-string-formatting)
             ...
             *
             * Read more at
             * [Axis docs](https://www.jabarsoft.com/docs/chart-concepts/axes)
    ...
    AxisDefaults.defaultYAxisOptions = {
         ...
         * [data classes](https://api.jabarsoft.com/highmaps#colorAxis.dataClasses)
