...
(function (factory) {
        ...
        /** @lends Highcharts.Annotation# */
        {
            ...
            defaultOptions: {
                ...
                labelOptions: {
                    ...
                    /**
                     * A
                     * [format](https://www.jabarsoft.com/docs/chart-concepts/labels-and-string-formatting)
        ...
        */
        ...
        setOptions({
            ...
            navigation: {
                 ...
                 *
                 * @type      {string}
                 * @default   https://code.jabarsoft.com/10.0.0/gfx/stock-icons/
                 * @since     7.1.3
    ...
    _registerModule(_modules, 'Stock/StockToolsBindings.js', [_modules['Core/DefaultOptions.js'], _modules['Core/Globals.js'], _modules['Extensions/Annotations/NavigationBindings.js'], _modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (D, H, NavigationBindings, Series, U) {
        ...
        var stockToolsBindings = {
             ...
             * [series.id](https://api.jabarsoft.com/highstock/series.line.id) to be
             * defined.
             *
             * @type    {Highcharts.NavigationBindingsOptionsObject}
             * @product highstock
        ...
        var Toolbar = /** @class */ (function () {
            ...
            Toolbar.prototype.getIconsURL = function () {
                return this.chart.options.navigation.iconsURL ||
                    ...
                    'https://code.jabarsoft.com/10.0.0/gfx/stock-icons/';
            };
            return Toolbar;
        }());
        /**
