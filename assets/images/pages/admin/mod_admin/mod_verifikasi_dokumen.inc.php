<?php
	...
	switch($param_idgroupakses){
		...
		break;
		default:
			$Qry="select a.idprdh, a.kdregister,a.nmdokumen,a.kddokumen, a.nmjudul, a.kdmap, b.nourut ,a.tglpengajuan, a.tglvalid, a.created_date, a.uraian from t_prohuk as a left join t_map_dokumen as b on a.kdmap=b.kdmap and a.kddokumen=b.kddokumen where a.idprdh>0 and b.idgroupakses='{$param_idgroupakses}' {$wh} order by a.created_date desc"; 
	}
	...
	while($Isi=_mysql_fetch_array($Qry)){ 
		...
		$ListMode.=" 
			<tr $wr  onmouseover=\"TG(this,'#FFCC33')\" onmouseout=\"TG(this,'$wh')\"> 
				...
				<td class='payment'>{$Isi['uraian']} </td>
				<td class='status'>
					$div
				</td>
				<td>
